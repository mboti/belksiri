...
// https://learn.microsoft.com/en-us/windows/win32/shell/links#creating-a-shortcut-and-a-folder-shortcut-to-a-file MBO
...
class ShortCutEx{
  ...
  launch(){
    ...
    // kbd.ref.ki.wVk = VK_F1;
    // List<kbd.ref.ki.wVk> list =[kbd.ref.ki.wVk]
    // launch2(list);
  }

  launch2(List<String> args) {
